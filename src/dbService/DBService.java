...
public class DBService {
    ...
    public UsersDataSet getUser(String username, String pass) throws DBException {
        try {
            UsersDAO dao = new UsersDAO(connection);
            UsersDataSet set= dao.get(dao.getUserId(username,pass));
    ...
    public BossDataSet getBossProfile(String name, String pass) throws DBException {
        try {
            UsersDAO dao = new UsersDAO(connection);
          	return dao.getBossProfile(name, pass);
...
return null;
	...
	public void addMessagetoBoss(String name, String achive)  {
		MessageDAO dao = new MessageDAO(connection);
	...
	public void minusScore(String price, Long id) throws DBException{
		try {
			connection.setAutoCommit(false);
		
        UsersDAO dao = new UsersDAO(connection);
       
        dao.minusScore(price, id);
        connection.commit();
	...
	public ArrayList<String> getBosses() throws SQLException{
		UsersDAO dao = new UsersDAO(connection);
    	return dao.getBosses();
	}

	public boolean checkUser(String login) throws SQLException {
		UsersDAO dao = new UsersDAO(connection);
		System.out.println(dao.checkUser(login));return dao.checkUser(login);
		
		
	}

	public void addNewAchive(String achive, String price, String bossid) throws DBException {
		try {
            connection.setAutoCommit(false);
            UsersDAO dao = new UsersDAO(connection);
           
            dao.addNewAchive( achive,  price,  bossid);
            connection.commit();
