...
private String messages;
	...
	public String toString() {
		return "UsersDataSet [id=" + id + ", name=" + name + ", username=" + username + ", password=" + password
				+ ", bossID=" + bossID + ", reachedachivesID=" + reachedachivesID + ", avaliableachevesID="
				+ avaliableachevesID + ", bossname=" + bossname + ", reachedachives=" + reachedachives
				+ ", avaliableacheves=" + avaliableacheves + ", score=" + score + ", messages=" + messages + "]";
	}
